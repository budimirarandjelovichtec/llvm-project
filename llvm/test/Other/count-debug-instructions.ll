; RUN: opt -passes=count-debug-instructions -S -disable-output 2>&1 %s | FileCheck %s
...
; CHECK-NEXT: llvm.dbg.values: 0
; CHECK-NEXT: llvm.dbg.declare: 2
; CHECK-NEXT: llvm.dbg.variableIntrinsic: 0
; CHECK: Function: main
; CHECK-NEXT: llvm.dbg.values: 0
; CHECK-NEXT: llvm.dbg.declare: 4
; CHECK-NEXT: llvm.dbg.variableIntrinsic: 0